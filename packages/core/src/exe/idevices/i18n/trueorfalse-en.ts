/**
 * Default English msgs for the `trueorfalse` game iDevice.
 * Mirrors `TrueFalseHandler.getDefaultMessages()` in the eXeLearning v4
 * repo (src/shared/import/legacy-handlers/TrueFalseHandler.ts).
 */
export const TRUEORFALSE_MSGS_EN = {
